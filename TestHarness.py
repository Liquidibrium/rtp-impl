...
def tests_to_run(forwarder):
    ...
    BasicTest.BasicTest("BasicTest_1kb", forwarder, "1kb_file")
    RandomDropTest.RandomDropTest("RandomDropTest_1kb", forwarder, "1kb_file")
    SackRandomDropTest.SackRandomDropTest("SackRandomDropTest_1kb", forwarder, "1kb_file")

    BasicTest.BasicTest("BasicTest_1mb", forwarder, "1mb_file")
    RandomDropTest.RandomDropTest("RandomDropTest_1mb", forwarder, "1mb_file")
    SackRandomDropTest.SackRandomDropTest("SackRandomDropTest_1mb", forwarder, "1mb_file")

    # BasicTest.BasicTest("BasicTest_10mb", forwarder, "10mb_file")
    # RandomDropTest.RandomDropTest("RandomDropTest_10mb", forwarder, "10mb_file")
    # SackRandomDropTest.SackRandomDropTest("SackRandomDropTest_10mb", forwarder, "10mb_file")

    # BasicTest.BasicTest("BasicTest_my", forwarder, "mytestfile_4307")
    # RandomDropTest.RandomDropTest("RandomDropTest_my", forwarder, "mytestfile_4307")
    # SackRandomDropTest.SackRandomDropTest("SackRandomDropTest_my", forwarder, "mytestfile_4307")
...
class Forwarder(object):
    ...
    def start(self, input_file):
        ...
        receiverCmd = ["python2.7", self.receiver_path,
                                     "-p", str(self.receiver_port)
                                    ]


        senderCmd = ["python2.7", self.sender_path,
                                   "-f", input_file,
                                   "-p", str(self.port)
                                  ]
...
class Packet(object):
    def __init__(self, packet, address, start_seqno_base, sackMode):
        ...
        try:
            ...
            assert(self.msg_type in ["syn", "fin", "dat", "ack", "sack"])
            int(self.checksum)
            self.bogon = False
